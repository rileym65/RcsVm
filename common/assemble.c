...
OPS ops[] = {
  ...
  { "LDSB [%r+i],%r",     "11CCCCC001001AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDSB [%r-n],%r",     "11CCCCC001001AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDSH [%r+%r],%r",    "11CCCCC001010AAAAA000000000BBBBB", 0 },
  { "LDSH [%r+i],%r",     "11CCCCC001010AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDSH [%r-n],%r",     "11CCCCC001010AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDUB [%r+%r],%r",    "11CCCCC000001AAAAA000000000BBBBB", 0 },
  { "LDUB [%r+i],%r",     "11CCCCC000001AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDUB [%r-n],%r",     "11CCCCC000001AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDUH [%r+%r],%r",    "11CCCCC000010AAAAA000000000BBBBB", 0 },
  { "LDUH [%r+i],%r",     "11CCCCC000010AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDUH [%r-n],%r",     "11CCCCC000010AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r+%r],%r",      "11CCCCC000000AAAAA000000000BBBBB", 0 },
  { "LD [%r+i],%r",       "11CCCCC000000AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r-n],%r",       "11CCCCC000000AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDD [%r+%r],%r",     "11CCCCC000011AAAAA000000000BBBBB", 0 },
  { "LDD [%r+i],%r",      "11CCCCC000011AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDD [%r-n],%r",      "11CCCCC000011AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r+%r],%f",      "11CCCCC100000AAAAA000000000BBBBB", 0 },
  { "LD [%r+i],%f",       "11CCCCC100000AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r-n],%f",       "11CCCCC100000AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDD [%r+%r],%f",     "11CCCCC100011AAAAA000000000BBBBB", 0 },
  { "LDD [%r+i],%f",      "11CCCCC100011AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDD [%r-n],%f",      "11CCCCC100011AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r+%r],%FSR",    "11CCCCC100001AAAAA000000000BBBBB", 0 },
  { "LD [%r+i],%FSR",     "11CCCCC100001AAAAA1BBBBBBBBBBBBB", 1 },
  { "LD [%r-n],%FSR",     "11CCCCC100001AAAAA1BBBBBBBBBBBBB", 1 },
  { "STB %r,[%r+%r]",     "11AAAAA000101BBBBB000000000CCCCC", 0 },
  { "STB %r,[%r+i]",      "11AAAAA000101BBBBB1CCCCCCCCCCCCC", 1 },
  { "STB %r,[%r-n]",      "11AAAAA000101BBBBB1CCCCCCCCCCCCC", 1 },
  { "STH %r,[%r+%r]",     "11AAAAA000110BBBBB000000000CCCCC", 0 },
  { "STH %r,[%r+i]",      "11AAAAA000110BBBBB1CCCCCCCCCCCCC", 1 },
  { "STH %r,[%r-n]",      "11AAAAA000110BBBBB1CCCCCCCCCCCCC", 1 },
  { "ST %r,[%r+%r]",      "11AAAAA000100BBBBB000000000CCCCC", 0 },
  { "ST %r,[%r+i]",       "11AAAAA000100BBBBB1CCCCCCCCCCCCC", 1 },
  { "ST %r,[%r-n]",       "11AAAAA000100BBBBB1CCCCCCCCCCCCC", 1 },
  { "STD %r,[%r+%r]",     "11AAAAA000111BBBBB000000000CCCCC", 0 },
  { "STD %r,[%r+i]",      "11AAAAA000111BBBBB1CCCCCCCCCCCCC", 1 },
  { "STD %r,[%r-n]",      "11AAAAA000111BBBBB1CCCCCCCCCCCCC", 1 },
  { "ST %FSR,[%r+%r]",    "1100000100101AAAAA000000000BBBBB", 0 },
  { "ST %FSR,[%r+i]",     "1100000100101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ST %FSR,[%r-n]",     "1100000100101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ST %f,[%r+%r]",      "11AAAAA100100BBBBB000000000CCCCC", 0 },
  { "ST %f,[%r+i]",       "11AAAAA100100BBBBB1CCCCCCCCCCCCC", 1 },
  { "ST %f,[%r-n]",       "11AAAAA100100BBBBB1CCCCCCCCCCCCC", 1 },
  { "STD %f,[%r+%r]",     "11AAAAA100111BBBBB000000000CCCCC", 0 },
  { "STD %f,[%r+i]",      "11AAAAA100111BBBBB1CCCCCCCCCCCCC", 1 },
  { "STD %f,[%r-n]",      "11AAAAA100111BBBBB1CCCCCCCCCCCCC", 1 },
  { "LDSTUB [%r+%r],%r",  "11CCCCC001101AAAAA000000000BBBBB", 0 },
  { "LDSTUB [%r+i],%r",   "11CCCCC001101AAAAA1BBBBBBBBBBBBB", 1 },
  { "LDSTUB [%r-n],%r",   "11CCCCC001101AAAAA1BBBBBBBBBBBBB", 1 },
  { "SWAP [%r+%r],%r",    "11CCCCC001111AAAAA000000000BBBBB", 0 },
  { "SWAP [%r+i],%r",     "11CCCCC001111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SWAP [%r-n],%r",     "11CCCCC001111AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "AND %r,i,%r",        "10CCCCC000001AAAAA1BBBBBBBBBBBBB", 1 },
  { "AND %r,+i,%r",       "10CCCCC000001AAAAA1BBBBBBBBBBBBB", 1 },
  { "AND %r,-n,%r",       "10CCCCC000001AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDCC %r,%r,%r",     "10CCCCC010001AAAAA000000000BBBBB", 0 },
  { "ANDCC %r,i,%r",      "10CCCCC010001AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDCC %r,+i,%r",     "10CCCCC010001AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDCC %r,-n,%r",     "10CCCCC010001AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDN %r,%r,%r",      "10CCCCC000101AAAAA000000000BBBBB", 0 },
  { "ANDN %r,i,%r",       "10CCCCC000101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDN %r,+i,%r",      "10CCCCC000101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDN %r,-n,%r",      "10CCCCC000101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDNCC %r,%r,%r",    "10CCCCC010101AAAAA000000000BBBBB", 0 },
  { "ANDNCC %r,i,%r",     "10CCCCC010101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDNCC %r,+i,%r",    "10CCCCC010101AAAAA1BBBBBBBBBBBBB", 1 },
  { "ANDNCC %r,-n,%r",    "10CCCCC010101AAAAA1BBBBBBBBBBBBB", 1 },
  { "OR %r,%r,%r",        "10CCCCC000010AAAAA000000000BBBBB", 0 },
  { "OR %r,i,%r",         "10CCCCC000010AAAAA1BBBBBBBBBBBBB", 1 },
  { "OR %r,+i,%r",        "10CCCCC000010AAAAA1BBBBBBBBBBBBB", 1 },
  { "OR %r,-n,%r",        "10CCCCC000010AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORCC %r,%r,%r",      "10CCCCC010010AAAAA000000000BBBBB", 0 },
  { "ORCC %r,i,%r",       "10CCCCC010010AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORCC %r,+i,%r",      "10CCCCC010010AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORCC %r,-n,%r",      "10CCCCC010010AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORN %r,%r,%r",       "10CCCCC000110AAAAA000000000BBBBB", 0 },
  { "ORN %r,i,%r",        "10CCCCC000110AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORN %r,+i,%r",       "10CCCCC000110AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORN %r,-n,%r",       "10CCCCC000110AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORNCC %r,%r,%r",     "10CCCCC010110AAAAA000000000BBBBB", 0 },
  { "ORNCC %r,i,%r",      "10CCCCC010110AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORNCC %r,+i,%r",     "10CCCCC010110AAAAA1BBBBBBBBBBBBB", 1 },
  { "ORNCC %r,-n,%r",     "10CCCCC010110AAAAA1BBBBBBBBBBBBB", 1 },
  { "XOR %r,%r,%r",       "10CCCCC000011AAAAA000000000BBBBB", 0 },
  { "XOR %r,i,%r",        "10CCCCC000011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XOR %r,+i,%r",       "10CCCCC000011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XOR %r,-n,%r",       "10CCCCC000011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XORCC %r,%r,%r",     "10CCCCC010011AAAAA000000000BBBBB", 0 },
  { "XORCC %r,i,%r",      "10CCCCC010011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XORCC %r,+i,%r",     "10CCCCC010011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XORCC %r,-n,%r",     "10CCCCC010011AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNOR %r,%r,%r",      "10CCCCC000111AAAAA000000000BBBBB", 0 },
  { "XNOR %r,i,%r",       "10CCCCC000111AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNOR %r,+i,%r",      "10CCCCC000111AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNOR %r,-n,%r",      "10CCCCC000111AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNORCC %r,%r,%r",    "10CCCCC010111AAAAA000000000BBBBB", 0 },
  { "XNORCC %r,i,%r",     "10CCCCC010111AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNORCC %r,+i,%r",    "10CCCCC010111AAAAA1BBBBBBBBBBBBB", 1 },
  { "XNORCC %r,-n,%r",    "10CCCCC010111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SLL %r,%r,%r",       "10CCCCC100101AAAAA000000000BBBBB", 0 },
  { "SLL %r,i,%r",        "10CCCCC100101AAAAA1BBBBBBBBBBBBB", 1 },
  { "SLL %r,+i,%r",       "10CCCCC100101AAAAA1BBBBBBBBBBBBB", 1 },
  { "SLL %r,-n,%r",       "10CCCCC100101AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRL %r,%r,%r",       "10CCCCC100110AAAAA000000000BBBBB", 0 },
  { "SRL %r,i,%r",        "10CCCCC100110AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRL %r,+i,%r",       "10CCCCC100110AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRL %r,-n,%r",       "10CCCCC100110AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRA %r,%r,%r",       "10CCCCC100111AAAAA000000000BBBBB", 0 },
  { "SRA %r,i,%r",        "10CCCCC100111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRA %r,+i,%r",       "10CCCCC100111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SRA %r,-n,%r",       "10CCCCC100111AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADD %r,%r,%r",       "10CCCCC000000AAAAA000000000BBBBB", 0 },
  { "ADD %r,i,%r",        "10CCCCC000000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADD %r,+i,%r",       "10CCCCC000000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADD %r,-n,%r",       "10CCCCC000000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDCC %r,%r,%r",     "10CCCCC010000AAAAA000000000BBBBB", 0 },
  { "ADDCC %r,i,%r",      "10CCCCC010000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDCC %r,+i,%r",     "10CCCCC010000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDCC %r,-n,%r",     "10CCCCC010000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDX %r,%r,%r",      "10CCCCC001000AAAAA000000000BBBBB", 0 },
  { "ADDX %r,i,%r",       "10CCCCC001000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDX %r,+i,%r",      "10CCCCC001000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDX %r,-n,%r",      "10CCCCC001000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDXCC %r,%r,%r",    "10CCCCC011000AAAAA000000000BBBBB", 0 },
  { "ADDXCC %r,i,%r",     "10CCCCC011000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDXCC %r,+i,%r",    "10CCCCC011000AAAAA1BBBBBBBBBBBBB", 1 },
  { "ADDXCC %r,-n,%r",    "10CCCCC011000AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUB %r,%r,%r",       "10CCCCC000100AAAAA000000000BBBBB", 0 },
  { "SUB %r,i,%r",        "10CCCCC000100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUB %r,+i,%r",       "10CCCCC000100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUB %r,-n,%r",       "10CCCCC000100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBCC %r,%r,%r",     "10CCCCC010100AAAAA000000000BBBBB", 0 },
  { "SUBCC %r,i,%r",      "10CCCCC010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBCC %r,+i,%r",     "10CCCCC010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBCC %r,-n,%r",     "10CCCCC010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBX %r,%r,%r",      "10CCCCC001100AAAAA000000000BBBBB", 0 },
  { "SUBX %r,i,%r",       "10CCCCC001100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBX %r,+i,%r",      "10CCCCC001100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBX %r,-n,%r",      "10CCCCC001100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBXCC %r,%r,%r",    "10CCCCC011100AAAAA000000000BBBBB", 0 },
  { "SUBXCC %r,i,%r",     "10CCCCC011100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBXCC %r,+i,%r",    "10CCCCC011100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SUBXCC %r,-n,%r",    "10CCCCC011100AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMUL %r,%r,%r",      "10CCCCC001010AAAAA000000000BBBBB", 0 },
  { "UMUL %r,i,%r",       "10CCCCC001010AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMUL %r,+i,%r",      "10CCCCC001010AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMUL %r,-n,%r",      "10CCCCC001010AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMULCC %r,%r,%r",    "10CCCCC011010AAAAA000000000BBBBB", 0 },
  { "UMULCC %r,i,%r",     "10CCCCC011010AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMULCC %r,+i,%r",    "10CCCCC011010AAAAA1BBBBBBBBBBBBB", 1 },
  { "UMULCC %r,-n,%r",    "10CCCCC011010AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMUL %r,%r,%r",      "10CCCCC001011AAAAA000000000BBBBB", 0 },
  { "SMUL %r,i,%r",       "10CCCCC001011AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMUL %r,+i,%r",      "10CCCCC001011AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMUL %r,-n,%r",      "10CCCCC001011AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMULCC %r,%r,%r",    "10CCCCC011011AAAAA000000000BBBBB", 0 },
  { "SMULCC %r,i,%r",     "10CCCCC011011AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMULCC %r,+i,%r",    "10CCCCC011011AAAAA1BBBBBBBBBBBBB", 1 },
  { "SMULCC %r,-n,%r",    "10CCCCC011011AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIV %r,%r,%r",      "10CCCCC001110AAAAA000000000BBBBB", 0 },
  { "UDIV %r,i,%r",       "10CCCCC001110AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIV %r,+i,%r",      "10CCCCC001110AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIV %r,-n,%r",      "10CCCCC001110AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIVCC %r,%r,%r",    "10CCCCC011110AAAAA000000000BBBBB", 0 },
  { "UDIVCC %r,i,%r",     "10CCCCC011110AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIVCC %r,+i,%r",    "10CCCCC011110AAAAA1BBBBBBBBBBBBB", 1 },
  { "UDIVCC %r,-n,%r",    "10CCCCC011110AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIV %r,%r,%r",      "10CCCCC001111AAAAA000000000BBBBB", 0 },
  { "SDIV %r,i,%r",       "10CCCCC001111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIV %r,+i,%r",      "10CCCCC001111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIV %r,-n,%r",      "10CCCCC001111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIVCC %r,%r,%r",    "10CCCCC011111AAAAA000000000BBBBB", 0 },
  { "SDIVCC %r,i,%r",     "10CCCCC011111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIVCC %r,+i,%r",    "10CCCCC011111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SDIVCC %r,-n,%r",    "10CCCCC011111AAAAA1BBBBBBBBBBBBB", 1 },
  { "SAVE %r,%r,%r",      "10CCCCC111100AAAAA000000000BBBBB", 0 },
  { "SAVE %r,i,%r",       "10CCCCC111100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SAVE %r,+i,%r",      "10CCCCC111100AAAAA1BBBBBBBBBBBBB", 1 },
  { "SAVE %r,-n,%r",      "10CCCCC111100AAAAA1BBBBBBBBBBBBB", 1 },
  { "RESTORE %r,%r,%r",   "10CCCCC111101AAAAA000000000BBBBB", 0 },
  { "RESTORE %r,i,%r",    "10CCCCC111101AAAAA1BBBBBBBBBBBBB", 1 },
  { "RESTORE %r,+i,%r",   "10CCCCC111101AAAAA1BBBBBBBBBBBBB", 1 },
  { "RESTORE %r,-n,%r",   "10CCCCC111101AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "JMPL %r+i,%r",       "10CCCCC111000AAAAA1BBBBBBBBBBBBB", 1 },
  { "JMPL %r-n,%r",       "10CCCCC111000AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "WR %r,i,%Y",         "1000000110000AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,+i,%Y",        "1000000110000AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,-n,%Y",        "1000000110000AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "RETT %r+i",          "1000000111001AAAAA1BBBBBBBBBBBBB", 1 },
  { "RETT %r-n",          "1000000111001AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "WR %r,i,%PSR",       "1000000110001AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,+i,%PSR",      "1000000110001AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,-n,%PSR",      "1000000110001AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,%r,%WIM",      "1000000110010AAAAA000000000BBBBB", 0 },
  { "WR %r,i,%WIM",       "1000000110010AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,+i,%WIM",      "1000000110010AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,-n,%WIM",      "1000000110010AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,%r,%TBR",      "1000000110011AAAAA000000000BBBBB", 0 },
  { "WR %r,i,%TBR",       "1000000110011AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,+i,%TBR",      "1000000110011AAAAA1BBBBBBBBBBBBB", 1 },
  { "WR %r,-n,%TBR",      "1000000110011AAAAA1BBBBBBBBBBBBB", 1 },

  { "CMP %r,%r",          "1000000010100AAAAA000000000BBBBB", 0 },
  { "CMP %r,i",           "1000000010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "CMP %r,+i",          "1000000010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "CMP %r,-n",          "1000000010100AAAAA1BBBBBBBBBBBBB", 1 },
  { "JMP %r+%r",          "1000000111000AAAAA000000000BBBBB", 0 },
  { "JMP %r+i",           "1000000111000AAAAA1BBBBBBBBBBBBB", 1 },
  { "JMP %r-n",           "1000000111000AAAAA1BBBBBBBBBBBBB", 1 },
  { "CALL %r+%r",         "1001111111000AAAAA000000000BBBBB", 0 },
  { "CALL %r+i",          "1001111111000AAAAA1BBBBBBBBBBBBB", 1 },
  { "CALL %r-n",          "1001111111000AAAAA1BBBBBBBBBBBBB", 1 },
  ...
  { "CLRB [%r+i]",        "1100000000101AAAAA1BBBBBBBBBBBBB", 1 },
  { "CLRB [%r-n]",        "1100000000101AAAAA1BBBBBBBBBBBBB", 1 },
  { "CLRH [%r+%r]",       "1100000000110AAAAA000000000BBBBB", 0 },
  { "CLRH [%r+i]",        "1100000000110AAAAA1BBBBBBBBBBBBB", 1 },
  { "CLRH [%r-n]",        "1100000000110AAAAA1BBBBBBBBBBBBB", 1 },
  { "CLR [%r+%r]",        "1100000000100AAAAA000000000BBBBB", 0 },
  { "CLR [%r+i]",         "1100000000100AAAAA1BBBBBBBBBBBBB", 1 },
  { "CLR [%r-n]",         "1100000000100AAAAA1BBBBBBBBBBBBB", 1 },
  { "MOV %r,%r",          "10BBBBB00001000000000000000AAAAA", 0 },
  { "MOV i,%r",           "10BBBBB000010000001AAAAAAAAAAAAA", 1 },
  { "MOV -n,%r",          "10BBBBB000010000001AAAAAAAAAAAAA", 1 },
  ...
  { "MOV i,%Y",           "1000000110000000001AAAAAAAAAAAAA", 1 },
  { "MOV -n,%Y",          "1000000110000000001AAAAAAAAAAAAA", 1 },
  { "MOV %r,%PSR",        "100000011000100000000000000AAAAA", 0 },
  { "MOV i,%PSR",         "1000000110001000001AAAAAAAAAAAAA", 1 },
  { "MOV -n,%PSR",        "1000000110001000001AAAAAAAAAAAAA", 1 },
  { "MOV %r,%WIM",        "100000011001000000000000000AAAAA", 0 },
  { "MOV i,%WIM",         "1000000110010000001AAAAAAAAAAAAA", 1 },
  { "MOV -n,%WIM",        "1000000110010000001AAAAAAAAAAAAA", 1 },
  { "MOV %r,%TBR",        "100000011001100000000000000AAAAA", 0 },
  { "MOV i,%TBR",         "1000000110011000001AAAAAAAAAAAAA", 1 },
  { "MOV -n,%TBR",        "1000000110011000001AAAAAAAAAAAAA", 1 },
